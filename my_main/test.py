...
def parse_args():
    ...
    parser.add_argument('--backbone-checkpoint',default='my_output/backbone/81_18.pth', help='checkpoint file')
    parser.add_argument('--head-checkpoint',default='VAEModel/weight/2022-11-18 22:40:45/val_acc_76.65777959187825_2450_epoch.pth')
    # parser.add_argument('--head-checkpoint',default='VAEModel/weight/2022-11-09 22:49:09/val_acc_75.58222405751546_900_epoch.pth' )
...
def main():
    ...
    if rank == 0:
        logger.info(f'load from backbone checkpoint: {args.backbone_checkpoint} ')
        logger.info(f'load from head checkpoint: {args.head_checkpoint} ')
        
        
    # backbone
    load_checkpoint(model, args.backbone_checkpoint, map_location='cpu')  # 装载 backbone
    model.head.VAE.load_vae_weight(args.head_checkpoint)  # 装载 VAE 模块
