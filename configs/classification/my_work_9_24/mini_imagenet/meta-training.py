...
evaluation = dict(by_epoch=False, interval=200, metric='accuracy')
...
model = dict(
    ...
    head=dict(type='ClipHead',
        comNet=dict(
            class_feature_file='my_output/save_class_feature_10_12/class_feautre.pickle',
            clip_file='clip_semantic_emb.pkl',
            in_dim = 640,
...
load_from = ('my_output/train_ComNet/best_accuracy_mean.pth')
